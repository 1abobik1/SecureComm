...
type Service interface {
	...
	Finalize(ctx context.Context, clientID string, encrypted []byte) (signature4 []byte, er error)
	DecryptWithSession(ctx context.Context, clientID string, data []byte) ([]byte, error)
}
